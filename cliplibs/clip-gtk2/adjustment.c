...
CLIP_DLLEXPORT GtkType _gtk_type_data() { return GTK_TYPE_ADJUSTMENT; }
long _clip_type_data() { return GTK_WIDGET_ADJUSTMENT; }
const char * _clip_type_name_data() { return "GTK_WIDGET_ADJUSTMENT"; }


int
clip_INIT___ADJUSTMENT(ClipMachine *cm)
{
	_wtype_table_put(_clip_type_adjustment, _clip_type_name_adjustment, _gtk_type_adjustment, _gtk_type_object, adj_signals);
