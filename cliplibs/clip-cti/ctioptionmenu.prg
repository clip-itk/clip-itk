...
function cti_option_menu_new(items)
	...
	obj:set_size		:= @cti_option_menu_set_size()
...
static function cti_option_menu_set_size(obj,height,width)
	CALL SUPER obj:set_size(height,width)
	obj:__menu:set_size(,width)
return

static function cti_option_menu_set_caption(obj,cCaption)
	cCaption := cti_text_justify(cCaption,obj:width-1,obj:__justification)+LB_PUSHSYM
...
static function cti_option_menu_init(obj)
	...
	obj:signal_connect(HASH_CTI_LOST_FOCUS_SIGNAL,{|_obj,_sig|_obj:close()})
