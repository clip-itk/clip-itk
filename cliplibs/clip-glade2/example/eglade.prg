...
return( 1 )
        ...
        que la propiedad 'handler' de las seńales con éstas.
        ...
        */
        ...
        must be 'delete_event'.
          clip-gtk utiliza el nombre antiguo de la seńal
        'delete_event'.
        */
...
/* Funciones gestoras de seńales. */

/*
  Main window delete_event handler
  Seńal recibida de la ventana principal
*/
