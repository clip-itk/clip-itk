...
/* added uri */
gdFontPtr gdSelectFont(int num);
void gdImageSector(gdImagePtr im, int cx, int cy, int w, int h, int s, int e, int color);
void gdImageFilledSector(gdImagePtr im, int cx, int cy, int w, int h, int s, int e, int color);
void gdImageTruncSector(gdImagePtr im, int cx, int cy, int w, int h, int we, int he, int s, int e, int color);
void gdImageFilledTruncSector(gdImagePtr im, int cx, int cy, int w, int h, int we, int he, int s, int e, int color);
void gdImageCharRotate(gdImagePtr im, gdFontPtr f, int x, int y, int c,	int a, int color);
void gdImageStringRotate(gdImagePtr im, gdFontPtr f, int x, int y, unsigned char *s, int a, int color);
