 ...
 *     SKINkey().
 *
 *     The piéce de resistance of FT_ACH2TB() is its ability to execute
...
FOR xx:= 1 to passes
  ret1:= A_CHOICE( 7,9,, ARRAY:t_arrey TITLEPOS:2 START_ELEM:ret1 ;
	   ...
	   REST_SCREEN:.F. AUTOEXEC:.F. MES_COLOR:"+w/b" ELEVBAR:"�" ) // utf-8: "▒"
  ...
  ret2:= A_CHOICE( 5,9,20,40 ARRAY:t_arrey2  BOXTYPE:B_DOUBLE ELEVBAR:"�" ;
	    ...
	    START_ELEM:3 SHADOW:"L" BAR_COLOR:"+r/gr*" TIME_OUT VALUE:-999 ) // utf-8: "░"
