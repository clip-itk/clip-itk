...
#translate SINGLEBOX(<top>, <left>, <bottom>, <right>) => ;
           @ <top>, <left>, <bottom>, <right> BOX "⁄ƒø≥Ÿƒ¿≥ " // utf-8: "‚îå‚îÄ‚îê‚îÇ‚îò‚îÄ‚îî‚îÇ "
#translate DOUBLEBOX(<top>, <left>, <bottom>, <right>) => ;
           @ <top>, <left>, <bottom>, <right> BOX '…Õª∫ºÕ»∫ ' // utf-8: '‚ïî‚ïê‚ïó‚ïë‚ïù‚ïê‚ïö‚ïë '
memvar getlist
...
@ board_[nelement][1,1], board_[nelement][1,2], board_[nelement][1,3], ;
  board_[nelement][1,4] box "⁄ƒø≥Ÿƒ¿≥ " // utf-8: "‚îå‚îÄ‚îê‚îÇ‚îò‚îÄ‚îî‚îÇ "
