...
gtk_ContainerAdd(bpgup, gdk_PixmapCreateFromXPMd(, pgupXPM))
bgotop := gtk_ButtonNew()
gtk_SignalConnect(bgotop, GTK_CLICKED_SIGNAL, {|btn| go_top()})
gtk_ContainerAdd(bgotop, gdk_PixmapCreateFromXPMd(, gotopXPM))
...
gtk_ContainerAdd(bpgdn, gdk_PixmapCreateFromXPMd(, pgdnXPM))
bgobottom := gtk_ButtonNew()
gtk_SignalConnect(bgobottom, GTK_CLICKED_SIGNAL, {|btn| go_bottom()})
gtk_ContainerAdd(bgobottom, gdk_PixmapCreateFromXPMd(, gobottomXPM))
