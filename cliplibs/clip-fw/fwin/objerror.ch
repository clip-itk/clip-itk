/* _GenError( nType, cClassName, cMethod )
    ...
    5             Error aÄadiendo M÷todo: No estÁ lincada la funci×n asociada.
...
/* errores de MAX_DEFINED_ERRORS a MAX_OBJECTS_ERRORS se consideran errores
   de usuario y este deberÁ proporcianar una descripci×n despues de
   llamar a _GenError()
*/
