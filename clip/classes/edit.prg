...
local nfile, str, spl, i, fd, curwin, oldwin, home, percent, nWin
	...
	set("edit_txtdir", curdir())   // ������������	set("edit_colors_edit",'11/1,0/2,0/3,0/7,1/3, 15/R') // �� �������
	set("edit_colors_window",'14/1') // �� �� �������
	set("edit_colors_view",'0/7,7/1,0/3,,1/3')  // �� �����	set("edit_colors_menu","0/7,0/2,r/7,g/rb,15/7,0/7") // �� ��
	...
	set("edit_tabpack",'yes')   // ��������������	set(_SET_SCOREBOARD,.t.)
	setcursor(1)
	//setcancel(.f.)
	::oMenu := ::menu()
